...
export const metadata: Metadata = { title: "Notifications - Betolla Staff" };
...
export default async function StaffNotificationsPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <NotificationsList notifications={notifications} locale={locale} orderHrefBase="/staff/orders" />
    </div>
  );
}
