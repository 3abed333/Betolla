...
export const metadata: Metadata = { title: "Report Detail - Betolla Staff" };

export default async function StaffDeliverySupportDetailPage({ params }: { params: Promise<{ id: string }> }) {
          ...
          <p className="text-sm text-ink-muted">
            ...
            {report.deliveryAssignment && (
              <>
                {" "}
                &middot;{" "}
                <Link href={`/staff/orders/${report.deliveryAssignment.order.id}`} className="text-cta hover:underline">
