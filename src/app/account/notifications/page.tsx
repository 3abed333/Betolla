...
export const metadata: Metadata = { title: "Notifications - Betolla Cosmetics" };
...
export default async function AccountNotificationsPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <NotificationsList notifications={notifications} locale={locale} orderHrefBase="/account/orders" />
    </div>
  );
}
